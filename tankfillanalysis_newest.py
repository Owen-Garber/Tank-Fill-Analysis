...
HEADER = ['Temp (K)','Nitrous Vented (kg)','M_Dot Ratio (Fill/Vent)','Fill Time (s)','Mass of Fluid in Flex Line (kg)','Excess Nitrous (kg)', 'Max Stoppage Time (s)', '\u0394P for Fill (psi)']
for item in HEADER:
